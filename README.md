...
* Gophers [Slack](http://invite.slack.golangbridge.org/) is a thriving, real-time messaging community. If you are looking to get immediate answers to questions or join in the conversation about Go with other Gophers, this is the place to be.
